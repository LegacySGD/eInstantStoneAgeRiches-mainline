...
public class StoneAgeRichesEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(StoneAgeRichesEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/StoneAgeRiches/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/StoneAgeRiches/InitOutcome.xml").getDocumentElement();
